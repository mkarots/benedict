...
Python 3.10+. Version 0.6.14. It does not download the project from GitHub for you.
...
How to set up a dev environment, run tests, and open a pull request: [CONTRIBUTING.md](CONTRIBUTING.md). Cursor agents: `.cursor/rules` and `.cursor/skills/github-issue`.
