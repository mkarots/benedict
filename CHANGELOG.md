...
### Changed
- Agent writing, design-doc, architecture, and version-bump rules live in `.cursor/rules/`. `CLAUDE.md` is an index. `.gitignore` tracks that folder and still ignores the rest of `.cursor/`.
