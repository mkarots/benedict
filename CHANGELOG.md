...
### Added
- Marketing landing page at `landing/index.html`, with a publish checklist in `landing/DEPLOY.md`. The page is not hosted yet.

### Changed
- Docs and landing chrome use charcoal (`#101010`) with the landing gold (`#d4a574`) as the accent. Material `brown` / `amber` is no longer the docs palette.
