...
7. Fill [`.github/PULL_REQUEST_TEMPLATE.md`](.github/PULL_REQUEST_TEMPLATE.md): Summary (what and why), Test plan (checkboxes), and a screenshot if the change is visual.
...
This repository ships Cursor project rules and a `github-issue` skill under `.cursor/`. Agents should read this file, [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md), the bug report template, and the pull request template. Treat a GitHub issue with `/github-issue <url>`.
